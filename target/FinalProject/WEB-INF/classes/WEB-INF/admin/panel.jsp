...
<%--           <a href="/change-password.do"><input type="button" value="Change password"></a><br/><br/>--%>
           <a href="/search-news.do"><input type="button" value="Search News"></a><br/><br/>
           <a href="/search-user.do"><input type="button" value="Search user"></a><br/><br/>
           <a href="/admin/add-user.do"><input type="button" value="Add user"></a><br/><br/>
           <a href="/list.do"><input type="button" value="List of users"></a><br/><br/>
